...
This repository is designed as an example modeling Hub that follows the infrastructure guidelines laid out by the [Consortium of Infectious Disease Modeling Hubs](https://github.com/testorg-rename/).
...
Install the [hubUtils package](https://testorg-rename.github.io/hubUtils/) to work with the data in R.
